...
while True:
	...
	print(f"\033[1;97m[\033[1;32m*\033[1;97m] \033[1;33m1.1 \033[1;97m: \033[1;34mTool Auto Golike Tiktok Flow v1 \033[1;32m[Online]")
	...
	if chon == '1':
		...
		exec(requests.get('https://raw.githubusercontent.com/devnth1110/AutoGolikeTiktokFlow/refs/heads/main/AutoGolikeTiktokFlow/AutoGolikeTiktokFlow.py').text)
	# elif chon == '1.2':
